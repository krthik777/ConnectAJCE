    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 text-gray-800 font-sans">
      ...
      <div className="relative z-10">
        ...
        <motion.header
          ...
          className="sticky top-0 z-50 bg-white/70 backdrop-blur-md border-b border-gray-200/50 shadow-sm"
        >
            ...
            <Link to="/" className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900">
                  Connect <span className="text-blue-700">AJCE</span>
                </h1>
              </div>
            </Link>
        ...
        <section
          ...
          style={{
            backgroundImage: `url(https://www.ajce.in/assets/css/images/bg.jpg)`,
          }}
        >
          <div className="absolute inset-0 bg-gradient-to-t from-blue-900/60 to-blue-700/20"></div>
          <div className="relative max-w-5xl mx-auto px-4 text-center z-10">
            ...
            >
              ...
              <p className="mt-4 text-lg sm:text-xl text-gray-200 max-w-3xl mx-auto drop-shadow-md">
                Developed by students to provide clear, reliable transportation
                info and guidance for anyone visiting our campus.
              </p>
            </motion.div>
            <motion.div
        ...
        <section ref={featuresRef} className="py-20 sm:py-24">
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              <h3 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">
                A Professional Transit Solution
              </h3>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We provide reliable and efficient services to ensure your
                commute is safe and punctual.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {/* Bus Card with Glass Morphism */}
              <motion.div
                variants={itemVariants}
                className="bg-white/70 backdrop-blur-sm rounded-xl border border-white/50 shadow-lg p-8 hover:shadow-xl hover:border-blue-300 transition-all duration-300"
              >
                ...
                <p className="text-gray-600 mb-5">
                  Access up-to-the-minute bus schedules for all major routes
                  connecting to the campus, ensuring you're always on time.
                </p>
                <Link
                  to="/bus-timings"
                  className="font-semibold text-blue-700 hover:text-blue-800 transition-colors duration-300 flex items-center gap-2"
                >
                  Check Schedules <ArrowRight className="w-4 h-4" />
                </Link>
              </motion.div>

              {/* Auto Card with Glass Morphism */}
              <motion.div
                variants={itemVariants}
                className="bg-white/70 backdrop-blur-sm rounded-xl border border-white/50 shadow-lg p-8 hover:shadow-xl hover:border-blue-300 transition-all duration-300"
              >
                ...
                <p className="text-gray-600 mb-5">
                  Connect directly with a network of trusted and verified
                  auto-rickshaw drivers for safe and reliable travel around the
                  area.
                </p>
                <Link
                  to="/auto-rickshaw"
        ...
        {/* <section ref={statsRef} className="py-20 bg-gray-100/50 border-y border-gray-200/50">
                        ...
                        >
                            {[
                                ...
                                <motion.div 
                                    key={index} 
                                    variants={itemVariants} 
                                    className="bg-white/70 backdrop-blur-sm p-6 rounded-xl border border-white/50 shadow-lg"
                                >
        ...
        {/* Campus Location Section with Google Maps */}
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Find your way to Amal Jyothi College of Engineering in
                Kanjirappally
              </p>
            </div>

            {/* Google Maps Embed */}
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl border border-white/50">
              <div className="aspect-w-16 aspect-h-9 w-full">
                <iframe
                  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAOVYRIgupAurZup5y1PRh8Ismb1A3lLao&q=9.52866,76.82344&zoom=18"
                  width="100%"
                  height="450"
                  style={{ border: 0 }}
                  allowFullScreen=""
              ...
              <div className="p-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <a
                    href="https://maps.app.goo.gl/Nv6mNKv9cAREo3X58?g_st=aw"
                    target="_blank"
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-gray-800 mb-2">By Bus</h5>
                    <p className="text-sm text-gray-600">
                      Multiple bus routes from Kanjirappally, Koovapally,
                      Erattupetta, Kottayam, and Pala
                    </p>
                  </div>
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      Verified auto services available from nearby towns
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-gray-700">
                This platform was developed as an official IEDC initiative by a
        ...
        <footer className="bg-gray-50 border-t border-gray-200">
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center space-y-4">
            ...
            <p className="text-xs text-gray-400 pt-6">
              Copyright © {new Date().getFullYear()} Connect AJCE. All Rights
              Reserved.
            </p>
          </div>
        </footer>
